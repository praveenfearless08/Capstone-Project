...
const Plans = () => {
  return (
    ...
    <div className="plans-container">
        ...
        <span className='stroke2'>OUR</span>
        <span className='middle'>SPECIAL</span>
        <span className='stroke2'>PLAN</span>
        ...
        <div className="plans">
                ...
                <button className='btn'>Purchase Now  <i class="ri-arrow-right-line"></i></button>
            </div>
            ))}
        </div>
    </div>
